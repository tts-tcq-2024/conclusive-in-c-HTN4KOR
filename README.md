...
- Enter Reflections: Replaced and given my inputs in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**Plan to reduce code complexity. Look from tester point of view. Reduce legacy coding**
